...
//        }
    ...
    public void saveState(State s) {
        s.cycles = cycles;
        s.clocks = clocks;
        s.A = A; s.X = X; s.Y = Y; s.S = S;
        s.PC = PC;
        s.carryFlag = carryFlag;
        s.zeroFlag = zeroFlag;
        s.interruptsDisabled = interruptsDisabled;
        s.decimalModeFlag = decimalModeFlag;
        s.overflowFlag = overflowFlag;
        s.negativeFlag = negativeFlag;
        s.previntflag = previntflag;
        s.nmi = nmi;
        s.prevnmi = prevnmi;
        s.logging = logging;
        s.pb = pb;
        ...
        s.nmiNext = nmiNext;
        s.idle = idle;
        s.interruptDelay = interruptDelay;
    }
    ...
    public void loadState(State s) {
        ...
        zeroFlag = s.zeroFlag;
        interruptsDisabled = s.interruptsDisabled;
        decimalModeFlag = s.decimalModeFlag;
        overflowFlag = s.overflowFlag;
        negativeFlag = s.negativeFlag;
        previntflag = s.previntflag;
        nmi = s.nmi;
        prevnmi = s.prevnmi;
        logging = s.logging;
        pb = s.pb;
        ...
        nmiNext = s.nmiNext;
        idle = s.idle;
        interruptDelay = s.interruptDelay;
    }
}
